...
export function MarksManagement({ students, classes }) {
  ...
  const syncGradesToBackend = async () => {
    // This would be called from AdminDashboard with accessToken
  ...
  const handleAddGrade = () => {
    if (!newGrade.studentId || !newGrade.subject || !newGrade.assignment || !newGrade.score) {
